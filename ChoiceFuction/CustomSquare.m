      ...
      withIconImage:(NSString *)imageString
{
    ...
    if (self) {
        ...
        // 图片icon
        UIImageView * imageIcon = [[UIImageView alloc]initWithFrame:CGRectMake(self.frame.size.width/2-18*ScreenWidth/375, 27*ScreenWidth/375, 36*ScreenWidth/375, 36*ScreenWidth/375)];
        imageIcon.image = [UIImage imageNamed:imageString];
        imageIcon.tag = self.gridId;
        [self addSubview:imageIcon];
        
        // 标题
        UILabel * title_label = [[UILabel alloc]initWithFrame:CGRectMake(self.frame.size.width/2-42*ScreenWidth/375, 68*ScreenWidth/375, 84*ScreenWidth/375, 20*ScreenWidth/375)];
        ...
        if (isAddDelete) {
            ...
            [deleteBtn setFrame:CGRectMake(self.frame.size.width-30*ScreenWidth/375, 10*ScreenWidth/375, 20*ScreenWidth/375, 20*ScreenWidth/375)];
...
- (void)gridClick:(CustomSquare *)clickItem
{
